...
const App = () => {
  ...
  return (
    <div className="wrapper w-full h-screen bg-zinc-900 overflow-x-hidden">
      <div className="main-content mb-8 sm:h-[calc(100vh-2rem)] max-w-11/12 w-11/12 lg:max-w-10/12 lg:w-10/12  pt-8 sm:pt-24 mx-auto flex flex-col sm:flex-row gap-7">
